...
export const oplRoutes = Object.freeze([
  currentRoute({ id: "public.home", path: "/", label: "公开首页", area: "public", role: "public", routeKind: "static_content", serviceBoundary: "StaticPublicContent" }),
  ...
  currentRoute({ id: "auth.logout", path: "/logout", label: "退出", area: "auth", role: "lab_owner", hiddenInMenu: true, routeKind: "auth_flow", serviceBoundary: "AuthController", apiRoutes: ["POST /api/auth/logout"], capabilities: ["read", "session"] }),
  ...
  currentRoute({ id: "console.overview", path: "/console/overview", label: "总览", area: "console", role: "lab_owner", menu: true, routeKind: "read_model", serviceBoundary: "ConsoleReadModelService", apiRoutes: ["GET /api/state", "GET /api/support/tickets"], capabilities: ["read", "summary"] }),
  ...
  currentRoute({ id: "compute-allocations.list", path: "/console/compute", label: "计算", area: "console", role: "lab_owner", menu: true, routeKind: "business_object", objectKind: "ComputeAllocation", serviceBoundary: "ComputeAllocationService", apiRoutes: ["GET /api/state", "GET /api/compute-allocations"], capabilities: ["list", "read", "evidence"] }),
  currentRoute({ id: "compute-allocations.create", path: "/console/compute/new", label: "开通计算分配", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "ComputeAllocation", serviceBoundary: "ComputeAllocationService", apiRoutes: ["GET /api/compute-pools", "POST /api/compute-allocations"], capabilities: ["read", "write", "action", "evidence"] }),
  currentRoute({ id: "compute-allocations.detail", path: "/console/compute/:id", label: "计算分配详情", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "ComputeAllocation", serviceBoundary: "ComputeAllocationService", apiRoutes: ["GET /api/compute-allocations/:id", "POST /api/compute-allocations/:id/destroy"], capabilities: ["detail", "read", "action", "evidence"] }),
  currentRoute({ id: "storage.list", path: "/console/storage", label: "存储", area: "console", role: "lab_owner", menu: true, routeKind: "business_object", objectKind: "StorageVolume", serviceBoundary: "ResourceProvisioningService", apiRoutes: ["GET /api/state"], capabilities: ["list", "read", "action", "evidence"] }),
  currentRoute({ id: "storage.create", path: "/console/storage/new", label: "开通存储", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "StorageVolume", serviceBoundary: "ResourceProvisioningService", apiRoutes: ["GET /api/state", "POST /api/storage-volumes"], capabilities: ["read", "write", "action", "evidence"] }),
  currentRoute({ id: "storage.detail", path: "/console/storage/:id", label: "存储详情", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "StorageVolume", serviceBoundary: "ResourceProvisioningService", apiRoutes: ["GET /api/state", "POST /api/storage-volumes/destroy"], capabilities: ["detail", "read", "action", "evidence"] }),
  currentRoute({ id: "attachment.list", path: "/console/attachments", label: "挂载", area: "console", role: "lab_owner", menu: true, routeKind: "business_object", objectKind: "StorageAttachment", serviceBoundary: "ResourceProvisioningService", apiRoutes: ["GET /api/state"], capabilities: ["list", "read", "action", "evidence"] }),
  ...
  currentRoute({ id: "workspace.list", path: "/console/workspaces", label: "工作区", area: "console", role: "lab_owner", menu: true, routeKind: "business_object", objectKind: "Workspace", serviceBoundary: "WorkspaceEntryService", apiRoutes: ["GET /api/state", "POST /api/workspaces/reset-token", "POST /api/workspaces/delete-token"], capabilities: ["list", "read", "action"] }),
  currentRoute({ id: "workspace.create", path: "/console/workspaces/new", label: "创建工作区", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "Workspace", serviceBoundary: "WorkspaceEntryService", apiRoutes: ["GET /api/state", "POST /api/workspaces"], capabilities: ["read", "write"] }),
  currentRoute({ id: "workspace.detail", path: "/console/workspaces/:id", label: "工作区详情", area: "console", role: "lab_owner", hiddenInMenu: true, routeKind: "business_object", objectKind: "Workspace", serviceBoundary: "WorkspaceEntryService", apiRoutes: ["GET /api/state", "POST /api/workspaces/reset-token", "POST /api/workspaces/delete-token", "POST /api/workspaces/runtime-status"], capabilities: ["detail", "read", "action", "evidence"] }),
  ...
  currentRoute({ id: "billing.overview", path: "/console/billing", label: "计费", area: "console", role: "lab_owner", menu: true, routeKind: "read_model", objectKind: "Wallet", serviceBoundary: "WalletService", apiRoutes: ["GET /api/state"], capabilities: ["read", "list", "detail"] }),
  ...
  currentRoute({ id: "support.list", path: "/console/support", label: "支持", area: "console", role: "lab_owner", menu: true, routeKind: "business_object", objectKind: "SupportTicket", serviceBoundary: "SupportTicketService", apiRoutes: ["GET /api/support/tickets"], capabilities: ["list", "read", "audit"] }),
  ...
  currentRoute({ id: "alerts.list", path: "/console/alerts", label: "告警", area: "console", role: "lab_owner", menu: true, routeKind: "read_model", objectKind: "RuntimeReadiness", serviceBoundary: "ConsoleReadModelService", apiRoutes: ["GET /api/state", "GET /api/support/tickets"], capabilities: ["read", "list"] }),
  ...
  currentRoute({ id: "admin.overview", path: "/admin/overview", label: "管理总览", area: "admin", role: "admin", adminMenu: true, routeKind: "read_model", serviceBoundary: "ConsoleReadModelService", apiRoutes: ["GET /api/state", "GET /api/operator/summary"], capabilities: ["read", "summary"] }),
  currentRoute({ id: "admin.users", path: "/admin/users", label: "用户", area: "admin", role: "admin", adminMenu: true, routeKind: "read_model", objectKind: "User", serviceBoundary: "ManagementModel", apiRoutes: ["GET /api/management/state", "POST /api/users", "POST /api/billing/topups"], capabilities: ["list", "read", "action", "audit"] }),
  currentRoute({ id: "admin.billing", path: "/admin/billing", label: "计费运营", area: "admin", role: "admin", adminMenu: true, routeKind: "read_model", objectKind: "Wallet", serviceBoundary: "WalletService", apiRoutes: ["GET /api/state", "POST /api/billing/topups"], capabilities: ["read", "list", "action", "audit"] }),
  ...
  currentRoute({ id: "admin.runtime", path: "/admin/runtime", label: "运行态", area: "admin", role: "admin", adminMenu: true, routeKind: "read_model", objectKind: "RuntimeReadiness", serviceBoundary: "RuntimeOperationService", apiRoutes: ["GET /api/runtime/readiness", "GET /api/production/readiness", "GET /api/operator/summary"], capabilities: ["read", "detail", "audit"] }),
  currentRoute({ id: "admin.support", path: "/admin/support", label: "支持运营", area: "admin", role: "admin", adminMenu: true, routeKind: "business_object", objectKind: "SupportTicket", serviceBoundary: "SupportTicketService", apiRoutes: ["GET /api/support/tickets"], capabilities: ["list", "read", "audit"] }),
